...
export default function DashboardPage() {
  ...
  const generateFakeClaim = async () => {
    ...
    const fakeClaim = {
      ...
      status: faker.helpers.arrayElement(['New', 'In Review', 'Closed']) as 'New' | 'In Review' | 'Closed',
      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">ClaimBridge Admin Portal</h1>
        ...
        <div className="px-4 py-4 sm:px-0">
          <div className="flex justify-between items-center mb-6">
            ...
            >
              ...
              {generatingClaim ? 'Generating...' : 'Generate Fake Claim'}
            </button>
          </div>
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-md">
            {loadingClaims ? (
              <div className="p-6 text-center">Loading claims...</div>
            ) : filteredClaims.length === 0 ? (
              <div className="p-6 text-center text-gray-500">
                {statusFilter === 'All' ? 'No claims found. Try generating a fake claim!' : `No ${statusFilter.toLowerCase()} claims found`}
              </div>
            ) : (
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="ml-2 flex-shrink-0 flex">
                              <p className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                                claim.status === 'New' ? 'bg-green-100 text-green-800' :
